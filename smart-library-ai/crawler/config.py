...
class Config:
    ...
    MINIO_BUCKET_AVATARS = os.getenv('MINIO_BUCKET_AVATARS', 'library-author-avatars')
    MINIO_BUCKET_USER_AVATARS = os.getenv('MINIO_BUCKET_USER_AVATARS', 'library-user-avatars')
