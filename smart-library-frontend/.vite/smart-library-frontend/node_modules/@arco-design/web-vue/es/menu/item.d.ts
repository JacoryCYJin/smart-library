declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    menuContext: Partial<Readonly<Pick<import("@arco-design/web-vue/es/menu/interfacen/web-vue/es/menu/interface").InternalMenuProps, "tooltipProps" | "mode" | "theme" | "triggerProps" | "popupMaxHeight" | "levelIndent" | "autoScrollIntoView" | "scrollConfig" | "inTrigger"> & {
        selectedKeys: string[];
        openKeys: string[];
        prefixCls: string;
        collapsed: boolean;
