...
import _Layout from '@arco-design/web-vue/es/layout/layoutsign/web-vue/es/layout/layout';
import _LayoutHeader from '@arco-design/web-vue/es/layout/headersign/web-vue/es/layout/header';
import _LayoutContent from '@arco-design/web-vue/es/layout/contentign/web-vue/es/layout/content';
import _LayoutFooter from '@arco-design/web-vue/es/layout/footersign/web-vue/es/layout/footer';
import _LayoutSider from '@arco-design/web-vue/es/layout/sideresign/web-vue/es/layout/sider';
    ...
    Sider: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
        ...
        ResizeBox: {
            new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
                ...
                onMoveStart: (direction: import("@arco-design/web-vue/es/resize-box/resize-boxresize-box/resize-box").DirectionType, e: MouseEvent) => void;
                isHorizontal: (direction: import("@arco-design/web-vue/es/resize-box/resize-boxresize-box/resize-box").DirectionType) => boolean;
                allowDirections: import("vue").ComputedRef<("top" | "bottom" | "left" | "right")[]>;
                onTiggerResize: (direction: import("@arco-design/web-vue/es/resize-box/resize-boxresize-box/resize-box").DirectionType, entry: ResizeObserverEntry) => void;
...
export type { LayoutProps, SiderProps } from '@arco-design/web-vue/es/layout/interfacen/web-vue/es/layout/interface';
