...
import _ResizeBox from '@arco-design/web-vue/es/resize-box/resize-box';
declare const ResizeBox: {
    new (...args: any[]): import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
        ...
        onMoveStart: (direction: import("@arco-design/web-vue/es/resize-box/resize-box").DirectionType, e: MouseEvent) => void;
        isHorizontal: (direction: import("@arco-design/web-vue/es/resize-box/resize-box").DirectionType) => boolean;
        allowDirections: import("vue").ComputedRef<("top" | "bottom" | "left" | "right")[]>;
        onTiggerResize: (direction: import("@arco-design/web-vue/es/resize-box/resize-box").DirectionType, entry: ResizeObserverEntry) => void;
