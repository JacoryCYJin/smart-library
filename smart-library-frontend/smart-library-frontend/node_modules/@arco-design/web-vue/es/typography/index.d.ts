...
import _Typography from '@arco-design/web-vue/es/typography/typography';
import _TypographyParagraph from '@arco-design/web-vue/es/typography/paragraph';
import _TypographyTitle from '@arco-design/web-vue/es/typography/title';
import _TypographyText from '@arco-design/web-vue/es/typography/text';
export type { EllipsisConfig } from '@arco-design/web-vue/es/typography/interface';
declare const Typography: {
    ...
    Text: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
        ellipsis: {
            type: import("vue").PropType<boolean | import("@arco-design/web-vue/es/typography/interface").EllipsisConfig>;
            default: boolean;
        };
    }>, {
        ...
        ellipsis: boolean | import("@arco-design/web-vue/es/typography/interface").EllipsisConfig;
    }, {}, {}, {}, string, import("vue").ComponentProvideOptions, true, {}, any>;
